...
EUP_MYEON: Final[dict[str, tuple[str, ...]]] = {
    ...
    "안동시": (
        ...
        # Administrative and legal 동. Dropping these silently demoted
        # ignition claims to county level, where D-006 gates them out of any
        # lead-time pairing.
        "중구동", "명륜동", "용상동", "태화동", "평화동", "안기동", "강남동",
        "옥동", "송하동", "수상동", "수하동", "정상동", "정하동", "안막동",
        "상아동", "신안동", "안흥동", "옥야동", "운흥동", "천리동", "법상동",
        "당북동", "서부동", "신세동", "법흥동", "성곡동", "노하동", "삼산동",
        "동부동", "남부동", "남문동", "대석동", "율세동", "광석동",
    ),
    "청송군": (
